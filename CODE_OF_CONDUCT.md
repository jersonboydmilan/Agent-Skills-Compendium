...
reported to the maintainer through https://jersonboydmilan.com/. All complaints
...
| | Impact | Consequence |
|---|---|---|
| **1. Correction** | Inappropriate language or unprofessional conduct | A private written warning, with clarity about the violation. A public apology may be requested. |
| **2. Warning** | A single incident or series of actions | A warning with consequences for continued behaviour, and no interaction with those involved for a specified period. |
| **3. Temporary ban** | A serious violation, including sustained inappropriate behaviour | A temporary ban from any interaction or public communication with the community. |
| **4. Permanent ban** | A pattern of violation, harassment, or aggression toward classes of individuals | A permanent ban from any public interaction within the community. |
